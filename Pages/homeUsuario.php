...
<body>
    ...
    <!---------------------------    Seccion inicio    ------------------------------->
    <section class="d-flex container-fluid justify-content-center align-items-center container-fondo">
        <div class="d-flex row justify-content-center">
            <div class="col custom-image-fondoUno">
            ...
            <div class="d-flex col justify-content-center align-items-center">
                <div class="custom-content">
                    <h1 class="custom-title text-center">
                        Entretenimiento como ningún otro
                    </h1>
                    <h1 class="custom-subtitle text-center">
                        Siempre
                    </h1>
                    <h1 class="custom-parag text-center align-self-center">
                        Entretenimiento para todas las edades al alcance de tu mano.
                    </h1>
                </div>
            </div>
        </div>
