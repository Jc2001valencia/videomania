...
<div class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    ...
    <section style="height: 100%; margin-top:60px;">
        <div class="d-flex container justify-content-center align-items-center">
            <div class="row justify-content-center">
                ...
                <div class="text-center w-25 rounded-4 mx-4 my-5 card">
                    <img class="custom-image" style="height: 400px;" src='<?php echo $movie->portada ?>' alt='Portada de la película'>
                    <div class="card-body">
                        <h3 class="text-truncate" style="width=100px;"> <?php echo $movie->titulo ?></h3>
                        <p class="pb-5"><?php echo $movie->descripcion ?></p>
                        <a href="../php/new_reproduccion.php?id=<?php echo $movie->id_pelicula?>" class="custom-link"> ver </a>
                    </div>
                </div>
