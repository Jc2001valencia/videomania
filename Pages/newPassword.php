...
if (isset($_GET['pwd'])) {
    $pwd = $_GET['pwd'];
    // Hacer algo con la contraseña aquí
}
?>
...
<body>
    ...
    <section class="d-flex container-fluid justify-content-center align-items-center container-form-recovery">
        <form class="custom-form">
            <div class="mb-3">
                <h1 class="m-5 custom-title">Se ha reestablecido tu contraseña</h1>
            </div>
            <div class="mb-3">
                <h1 class="m-5 text-light text-center custom-subtitle">
                    Puedes seguir disfrutando de tus peliculas favoritas.
                </h1>
            </div>
            <div class="mb-3">
                <h1 class="m-5 text-light text-center custom-subtitle">
                    Tu nueva contraseña: <h1 class="m-5 text-light text-center custom-password"><?php  echo $pwd; ?></h1>
                </h1>
            </div>
            <div class="row justify-content-center">
                <button type="submit" class="custom-button">
                    <a class="custom-link" href="sesion.php"> Iniciar sesión </a>
                </button>
            </div>
        </form>
    </section>
